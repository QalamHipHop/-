...
type Token struct {
	...
	GraduationRialMinor int64       `json:"graduation_rial_minor,string"`
...
type BondingState struct {
	...
	SupplyCirculatingMinor    int64     `json:"supply_circulating_minor,string"`
	ReserveRialMinor          int64     `json:"reserve_rial_minor,string"`
	VirtualRialMinor          int64     `json:"virtual_rial_minor,string"`
...
type VestingSchedule struct {
	...
	ReleasedMinor   int64     `json:"released_minor,string"`
...
type BuyQuote struct {
	...
	AmountInMinor   int64  `json:"amount_in_minor,string"`
	AmountOutMinor  int64  `json:"amount_out_minor,string"`
	FeeMinor        int64  `json:"fee_minor,string"`
	PriceImpactBps  int    `json:"price_impact_bps"`
	NewReserveMinor int64  `json:"new_reserve_minor,string"`
	NewSupplyMinor  int64  `json:"new_supply_minor,string"`
